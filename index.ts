...
// Suppress errors about isInteger
...
export class Fraction {
	...
	constructor(numerator: any = 0, denominator: any = 1) {
		let frac;
	...
	static add(frac1: any, frac2: any) {
	...
	static subtract(frac1: any, frac2: any) {
		Fraction.correctArgumentLength(2, arguments.length);
		frac1 = Fraction.toFraction(frac1);
		frac2 = Fraction.toFraction(frac2);
	...
	static multiply(frac1: any, frac2: any) {
		Fraction.correctArgumentLength(2, arguments.length);
		frac1 = Fraction.toFraction(frac1);
		frac2 = Fraction.toFraction(frac2);
	...
	static divide(frac1: any, frac2: any) {
		Fraction.correctArgumentLength(2, arguments.length);
		frac1 = Fraction.toFraction(frac1);
		frac2 = Fraction.toFraction(frac2);
	...
	static greatestCommonDivisor(num1: any, num2: any) {
		let greater;
		let lesser;
	...
	static equals(frac1: any, frac2: any) {
		Fraction.correctArgumentLength(2, arguments.length);
		frac1 = Fraction.toFraction(frac1);
		frac2 = Fraction.toFraction(frac2);
	...
	static valueOf(frac: any) {
		Fraction.correctArgumentLength(1, arguments.length);
		frac = Fraction.toFraction(frac);
		return frac.numerator / frac.denominator;
	}

	static correctArgumentLength(ideal: any, actual: any) {
		if (ideal != actual) {
			throw new Error('' + ideal + ' arguments needed');
		}
	}

	static change(oldFrac: any, newFrac: any) {
		Fraction.correctArgumentLength(2, arguments.length);
	...
	static fromFraction(frac: any) {
		return typeof(frac) == 'object' && frac.constructor == Fraction;
	}

	static toFraction(x: any) {
	...
	static decimalToFraction(x: any) {
		Fraction.correctArgumentLength(1, arguments.length);
		if (isNaN(x)) {
